...
var parseJSONResponse = /*#__PURE__*/function () {
  ...
  return function parseJSONResponse(_x) {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var API_URL = 'http://127.0.0.1:8000/api/v1/users';
var parseJSONResponse = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(response) {
    var contentType, text;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch("".concat(API_URL, "/updateMe"), {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json'
            },
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(currentPassword, password, passwordConfirm) {
    var res, data;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return fetch("".concat(API_URL, "/UpdatePassword"), {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json'
            },
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log('Submitting user data update:', {
              name: name,
              email: email
            });
            _context.next = 6;
            return (0, _updateSetting.updateUserData)(name, email);
          case 6:
          case "end":
            return _context.stop();
        }
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 7;
            return (0, _updateSetting.updatePassword)(currentPassword, password, passwordConfirm);
          case 7:
          case "end":
            return _context2.stop();
        }
